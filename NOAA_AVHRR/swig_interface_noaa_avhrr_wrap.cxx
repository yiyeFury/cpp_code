...
/*-----------------------------------------------
              @(target):= _NOAA_AVHRR_CPP.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__NOAA_AVHRR_CPP

#else
#  define SWIG_init    init_NOAA_AVHRR_CPP

#endif
#define SWIG_name    "_NOAA_AVHRR_CPP"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_EarthDataSplitFunc(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "EarthDataSplitFunc", 2, 2, swig_obj)) SWIG_fail;
  {
    npy_intp size[1] = {
      -1 
    };
  ...
  {
    array3 = obj_to_array_no_conversion(swig_obj[1], NPY_FLOAT);
  ...
  EarthDataSplitFunc(arg1,arg2,arg3,arg4,arg5);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "EarthDataSplitFunc", _wrap_EarthDataSplitFunc, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
