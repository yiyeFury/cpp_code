...
# class ************************************************************************
# function *********************************************************************
module_name = 'SPA'  # 模块名字，python中import的名字
swig_interface_file_name = 'swig_interface_spa.i'  # swig接口文件名字
cpp_name = 'SPA.cpp'  # cpp 脚本的名字
...
setup(name=module_name,
      version='0.1',
      author="xzl",
      description="""swig bind cpp and python for SPA""",
      # ext_modules=[example_module],
