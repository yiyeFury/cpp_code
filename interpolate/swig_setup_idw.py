...
# class ************************************************************************
# function *********************************************************************
module_name = 'IDW'  # 模块名字，python中import的名字
swig_interface_file_name = 'swig_interface_idw.i'  # swig接口文件名字
cpp_name = 'IDW.cpp'  # cpp 脚本的名字
...
example_module = Extension(extension_name,
                           sources=extension_source,
                           include_dirs=[np.get_include()],  # include_dirs=[np.get_include(), eigen_dir],
...
setup(name=module_name,
      version='0.1',
      author="xzl",
      description="""swig bind cpp and python for IDW""",
      # ext_modules=[example_module],
