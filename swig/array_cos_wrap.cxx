...
/*-----------------------------------------------
              @(target):= _array_cos.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__array_cos

#else
#  define SWIG_init    init_array_cos

#endif
#define SWIG_name    "_array_cos"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_array_cos_func(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "array_cos_func", 2, 2, swig_obj)) SWIG_fail;
  {
    npy_intp size[1] = {
      -1 
    };
  ...
  array_cos_func(arg1,arg2,arg3,arg4);
...
SWIGINTERN PyObject *_wrap_leap_year(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "leap_year" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  result = (int)leap_year(arg1);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "array_cos_func", _wrap_array_cos_func, METH_VARARGS, NULL},
	 { "leap_year", _wrap_leap_year, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
